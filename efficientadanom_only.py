...
from common import get_autoencoder, Autoencoder,get_pdn_small, get_pdn_medium, \
    ...
    for iteration, (image_st, image_ae), image_penalty in zip(
        ...
        if iteration % 10 == 0:
            tqdm_obj.set_description(
                "Current loss: {:.4f} (AE: {:.4f}, ST-AE: {:.4f})  ".format(
                    loss_total.item(), loss_ae.item(), loss_stae.item()))
